...
Papers will be selected through a **double-blind**^[This means that the authors name should not appear in the submitted document for the first review phase nor in the submitted name file.] refereeing process based on the submitted full papers.
...
- [**Submission kit here**](assets/paper-template/2022_ICE_IAMOT_IEEE_Authors Kit.docx) 
...
Papers are expected to be submitted in **A4 format using the IEEE ICE-IAMOT 2022 paper template** that further contains all relevant explanations about papers’ structure and layout as well as needed copyright information.

## Reviewing process


```{r echo=FALSE, "class=external", layout="l-body", out.extra="class=external", fig.align='center'}
knitr::include_graphics("figures/review.png")
```
...
- (c) The scientific/innovation quality of the approach described in the article. 
- (d) The redaction quality and clarity.
...
Please see our IEEE ICE-IAMOT 2022 Author’s Kit for detailed instructions about all relevant dates, correct submission of needed documents, and Conference Proceedings.
